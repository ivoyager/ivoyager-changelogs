...
* After years of frustration with Excel "interpreting" and modifying table values (e.g., changing the Sun's GM from 1.32712440018e20 to 1.33E+20) and trying to thwart that with ' or _ prefixes (but missing cases) I have switched to a new .csv/.tsv editor: [Ron's CSV Editor](https://www.ronsplace.eu/Products/RonsEditor/Download). So far, it's working superbly! The consequence however is that I'm no longer trying to maintain "Excel-safety", so .tsv files opened and saved in Excel will be trashed.
